...
export default function AdminOrders() {
  ...
  const PAYMENT_OPTIONS = [
    ...
    { value: 'PENDING_OFFLINE', label: 'Pending Offline' },
    { value: 'UPI_PENDING', label: 'UPI Pending' },
    { value: 'PAID_UPI', label: 'Paid via UPI' },
    ...
    <div>
      ...
      {loading ? (
        <div className="space-y-2">
          {[...Array(6)].map((_, i) => <div key={i} className="h-16 bg-stone-100 rounded-2xl animate-pulse" />)}
        </div>
      ) : (
        <div className="space-y-2">
          {orders.length === 0 && (
          ...
          {orders.map(order => (
            <div key={order.id} className="bg-white rounded-2xl border border-stone-100 overflow-hidden">
              {/* Row */}
              <div
                className="flex items-center gap-4 px-4 py-3 cursor-pointer hover:bg-stone-50"
              ...
              >
                ...
                <div className="flex items-center gap-3 shrink-0">
                  ...
                  <span className="font-black text-orange-600 text-sm w-16 text-right">₹{order.totalAmount}</span>
                    ...
                    <div>
                      ...
                      <div className="space-y-2">
                        ...
                        <div>
                          ...
                          <select
                            className="input text-sm"
                            value={order.isDelivered ? 'true' : 'false'}
